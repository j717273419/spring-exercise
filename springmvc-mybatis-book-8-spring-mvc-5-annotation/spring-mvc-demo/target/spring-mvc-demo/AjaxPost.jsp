...
<head>
    ...
    <script>
        ...
        function commitJson2(){
            $.ajax({
                type: 'POST',
                url: "${pageContext.request.contextPath}/jsonpost2",
                // contentType: "application/json; charset=utf-8",
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                data: {"name":"abc123","age":"333","id":222},
                dataType: "json",//期待返回的数据类型
                success: function(data){
                    $("#commit-result").text(JSON.stringify(data))
                },
...
<button id="commitJson2" onclick="commitJson2()">提交json格式数据，后台对象接收</button>
